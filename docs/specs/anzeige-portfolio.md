...
- **AC3 — Klickbare Gates:** Anstehende Entscheidungs-Gates sind in der Anzeige bedienbar (PM anstossen / warten). Mechanismus (ADR-011, Owner-Entscheid 2026-07-30, bindend): „bedienbar" heisst konkret **kopierbar** — die Anzeige zeigt zum anstehenden Gate den fertigen Befehl (inkl. Themen-/Lauf-Kontext) als Text mit Kopieren-Button; die Ausführung selbst passiert im Terminal über die bestehende Schicht-1-Schnittstelle (`gate-pm-anstoss.md`), nie an ihr vorbei. Kein Auto-Submit, keine Aktion, die selbst schreibt — die Anzeige bleibt dadurch strukturell lesend (deckungsgleich mit AC4). „Warten" ist der Nicht-Klick (kein Gegenstück-Button nötig, das Gate bleibt einfach unbeantwortet sichtbar).
